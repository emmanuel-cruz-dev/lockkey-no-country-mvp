          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <div className="w-1/2">
                ...
                >
                  {t("components.passwordModal.userName")}:
                </label>
                <input
                  type="text"
                  className="w-full border rounded p-2 text-gray-800"
              ...
              <div className="w-1/2">
                ...
                >
                  {t("components.passwordModal.sitePassword")}:
                </label>
                <div className="relative">
                  ...
                  {password && (
                    <button
                      ...
                      title={
                        showPassword
                          ? t("components.passwordModal.hidePassword")
                          : t("components.passwordModal.showPassword")
                      }
                    >
                      {showPassword ? (
                        <svg
            ...
            <div>
              ...
              >
                {t("components.passwordModal.notes")}:
              </label>
              <textarea
